...
var Manager = /** @class */ (function (_super) {
    ...
    function Manager(firstName, lastName, jobTitle, department) {
        var _this = _super.call(this, firstName, lastName, jobTitle) || this;
        _this.department = department;
        return _this;
    }
    Manager.prototype.describe = function () {
        return _super.prototype.describe.call(this) + "I work in the ".concat(this.department, " department");
    };
    return Manager;
}(Employee));
var mabratu = new Manager('Mabratu', 'Smith', 'Dept head', 'high tech');
